...
export const Login = () => {
  ...
  const handleTraditionalSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err.message || 'Server error. Failed to log in.');
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="auth-visual-side">
        ...
        <div className="auth-visual-inner">
          ...
          <p className="auth-visual-description">
            Connect dynamically with developers, designers, runners, and collaborators near you in real-time. Share tasks, find peers, and build your local community.
          </p>
        </div>
      ...
      <div className="auth-form-side">
        <div className="auth-form-inner">
          ...
          <p className="auth-welcome-subtitle">
            Don't have an account? <Link to="/register" className="auth-welcome-link">Create a new account now</Link>. It's FREE! Takes less than a minute.
          </p>
